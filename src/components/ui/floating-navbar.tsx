    ...
    <nav className="fixed left-0 right-0 top-0 z-50 px-4 py-6">
      <div className="mx-auto flex max-w-7xl items-center justify-center gap-4">
        <button
          ...
          className="rounded-2xl border border-white/10 bg-white/5 px-4 py-5 backdrop-blur-md transition-all duration-300 hover:bg-white/10 hover:border-white/20"
          ...
          <div className="flex items-center gap-2">
            {language === 'en' ? (
              <>
                ...
                <span className="text-sm font-semibold text-white font-open-sans-custom">FR</span>
              </>
            ) : (
              <>
                ...
                <span className="text-sm font-semibold text-white font-open-sans-custom">EN</span>
              </>
            )}
          </div>
        </button>
